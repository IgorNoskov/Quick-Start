...
class Theme_Example_Widget extends WP_Widget {
	...
	public function __construct() {
		$this->id_base = 'class-theme-example-widget';

		$name = __( 'Theme Example Widget', 'quick-start' );

		$widget_options = array(
			'classname'                   => 'theme-example-widget',
			'description'                 => __( 'Example text widget', 'quick-start' ),
		...
		parent::__construct( $this->id_base, $name, $widget_options, $control_options );
	}
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'New title', 'quick-start' );
